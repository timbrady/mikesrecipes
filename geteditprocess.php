...
echo "<h2>Edit a Recipe</h2>";
 ...
 $counterstart = $count;
    ...
    while ($row = mysql_fetch_array($result,MYSQL_ASSOC))
    {
        ...
        {
        echo "<li><font size=+1><a href=/recipes/"; echo "$wordfile"; echo">$title</a> [ <a href=editProcess.php?wordfile=$wordfile>Edit</a> ]</font><br>";
        if ($abstract == "")
        {echo "<br>";}
...
echo "</ul>";
    ...
    if ($count > 0) {echo "<a href='geteditprocess.php?search=";echo"$value";echo"&num=";echo"$prevcounter";echo"'>Previous 20</a> | ";}
    
    
echo "<a href='geteditprocess.php?search=";echo"$value";echo"&num=";echo"$nextcounter";echo"'>Next 20</a><br><br>";
    
echo "
<form action='geteditprocess.php' method='get'>
