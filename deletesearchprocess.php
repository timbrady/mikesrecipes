...
EXTRACT($row);
    ...
    $title2 = trim($title);
    $temp_title = ereg_replace(" ","_",$title2);

echo "<li><u>$title</u> [ <a href=deleteProcess.php?title=$temp_title>Delete</a> ]<br>";
if ($abstract == "")
    {echo "<br>";}
...
echo "<form action='deletesearchprocess.php' method='POST'>
